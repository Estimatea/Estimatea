...
public class TaskRepository {
    ...
    private final String CREATE_TASK_FOR_SUBPROJECT = "INSERT INTO task (start_date, completed, task_name, deadline, task_time, task_price, sub_id,current_complexity_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";

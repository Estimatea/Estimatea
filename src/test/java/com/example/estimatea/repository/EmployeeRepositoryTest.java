...
//        int subProjectId = 1;
//
//        List<Integer> employeesBeforeAdding = employeeRepository.getAllEmployeesIdsForSubProject(subProjectId);
//
...
//
//        List<Integer> afterAddingEmployeeToSubProject = employeeRepository.getAllEmployeesIdsForSubProject(subProjectId);
//
...
//        int subProjectId = 1;
//
//        List<Integer> employeesBeforeRemoval = employeeRepository.getAllEmployeesIdsForSubProject(subProjectId);
//
//        assertThat(employeesBeforeRemoval).contains(joakimId);
//
//        int initialSize = employeesBeforeRemoval.size();
...
//
//        List<Integer> employeesAfterRemoval = employeeRepository.getAllEmployeesIdsForSubProject(subProjectId);
//
//        assertThat(employeesAfterRemoval).hasSize(initialSize - 1);
//        assertThat(employeesAfterRemoval).doesNotContain(joakimId);
//    }

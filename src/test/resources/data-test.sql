...
VALUES (1, 'Project Manager', 2500),
       (2, 'Subproject Manager', 1500),
       (3, 'Program Manager', 1200);

-- 2. Employees
INSERT INTO employee (employee_id, employee_name, employee_username, employee_password, role_id)
VALUES (1, 'Joakim', 'joakim_dev', 'password_123', 1),
       (2, 'Emil', 'emil_dev', 'password_456', 2),
       (3, 'Simon', 'simon_dev', 'password_678', 3);
...
VALUES (1, 'Project calculation tool', '2026-02-01', '2026-03-01', false, 1);

-- 5. Complexity Scores
INSERT INTO complexity (complexity_id, complexity_score, label_type, rate_multiplier)
VALUES (1, 1, 'Standard', 1.0),
       (5, 5, 'Elevated', 1.5),
       (10, 10, 'Enterprise Grade', 3.0);